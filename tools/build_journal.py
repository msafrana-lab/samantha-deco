...
I18N = {
    "fr": dict(
        ...
        fin_titre="Parlons de chez vous",
        ...
        foot_desc="Décoration d'intérieur sur les deux rives du Léman. Je suis basée à Évian-les-Bains et j'interviens de Thonon à Lausanne.",
        ...
        copyright="© 2026 Rives Intérieures. Samantha, décoratrice d'intérieur à Évian-les-Bains.",
        other_label="English",
    ...
    "en": dict(
        ...
        fin_titre="Let's talk about your home",
        ...
        foot_desc="Interior design on both shores of Lake Geneva. I am based in Évian-les-Bains and work from Thonon to Lausanne.",
        ...
        copyright="© 2026 Rives Intérieures. Samantha, interior decorator in Évian-les-Bains, France.",
...
<h2>Et pour chez vous</h2>
<p>Ces cinq principes forment la colonne vertébrale de la plupart de mes projets « vue lac ». La difficulté, c'est de les appliquer à VOS volumes : où pivoter le canapé quand le radiateur bloque le mur idéal, comment habiller une baie de 4 mètres sans budget pharaonique. C'est exactement ce qu'on résout en <a href="/prestations/#visite">Visite Conseil</a>, deux heures chez vous, et le plan d'action est posé.</p>
""",
  body_en="""
...
<h2>And for your home</h2>
<p>These five principles are the backbone of most of my lake-view projects. The difficulty is applying them to <em>your</em> volumes: where to rotate the sofa when a radiator blocks the ideal wall, how to dress a four-metre window without a monumental budget. That is precisely what an <a href="/en/services/#visite">Advice Visit</a> solves: two hours at your home, and the action plan is set.</p>
""",
),
dict(
...
<p>Un bureau dans la chambre pose une question de territoire : tout l'enjeu est d'empêcher le travail de coloniser le sommeil. Les études sur le sujet convergent : un espace de travail visible depuis le lit dégrade l'endormissement. La solution, c'est de <strong>marquer la frontière</strong>.</p>
...
<p>A desk in the bedroom raises a question of territory: the whole challenge is stopping work from colonising sleep. Research converges on this: a workstation visible from the bed degrades sleep onset. The solution is to <strong>mark the boundary</strong>.</p>
...
<p>Repeindre tout en blanc, c'est souvent un réflexe plus qu'un vrai projet. La peinture devient un levier quand elle est stratégique : un soubassement qui rehausse les plafonds, une teinte profonde qui donne un fond aux meubles clairs, des boiseries et cadres de portes traités en contraste. Dans une cuisine, repeindre les façades (avec la bonne préparation et la bonne laque) change davantage la pièce que remplacer les meubles, pour un dixième du prix.</p>
...
<p>Repainting everything white is more of a reflex than a real project. Paint becomes a lever when it is strategic: a painted lower wall that visually lifts the ceiling, a deep tone that gives light furniture a backdrop, woodwork and door frames treated in contrast. In a kitchen, repainting the fronts (with proper preparation and the right lacquer) changes the room more than replacing the units, at a tenth of the price.</p>
...
<p>Les petites fenêtres n'expliquent pas tout. Le bois vernis orangé absorbe une part importante de la lumière et la teinte de ce qu'il en rend. Sol, murs et plafond dans le même bois : l'œil ne trouve aucun repère de luminosité, et la pièce entière semble fermer les yeux.</p>
...
<p>Small windows are only part of the story. Orange-varnished timber absorbs a large share of the light and tints whatever it returns. Floor, walls and ceiling in the same wood: the eye finds no luminosity reference, and the whole room seems to close its eyes.</p>
...
dict(
  ...
  lead_fr="Toutes les régions ont une lumière, et toutes les lumières ont leurs couleurs alliées. Celle du Léman (douce, changeante, réfléchie par l'eau) a les siennes. Trois teintes reviennent sans cesse dans mes projets, et il y a de bonnes raisons à ça.",
  lead_en="Every region has its light, and every light has its allied colours. Lake Geneva's (soft, changing, reflected by the water) has its own. Three tones keep returning in my projects, for good reasons.",
  body_fr="""
...
<p>Quand les journées raccourcissent, le laiton (patères, cadres, robinetterie, pieds de lampe) apporte une chaleur que l'argenté ne donne pas. Dosage strict : c'est un condiment, pas un plat. Trois à cinq points de laiton par pièce suffisent ; au-delà, on bascule dans le lobby d'hôtel.</p>
...
<p>La règle 70/20/10 est connue. Ce qui change tout ici, c'est son application locale : le fond doit être chaud, jamais blanc pur, et les teintes d'ancrage gagnent à faire écho au paysage. C'est exactement le genre de calibrage qu'on règle ensemble en <a href="/prestations/#visite">Visite Conseil</a>, échantillons en main, dans VOTRE lumière.</p>
""",
  body_en="""
...
<p>As the days shorten, brass (hooks, frames, taps, lamp bases) brings a warmth that chrome never gives. Strict dosage: it is a condiment, not a dish. Three to five brass points per room are enough; beyond that, you tip into hotel lobby.</p>
...
<p>The 70/20/10 rule is well known. What changes everything here is the local application: the background must be warm, never pure white, and the anchoring tones benefit from echoing the landscape. It is exactly the kind of calibration we settle together during an <a href="/en/services/#visite">Advice Visit</a>, samples in hand, in YOUR light.</p>
""",
),
dict(
...
<p>Le canapé trop grand commandé sur un coup de tête : 2 000 €. La teinte repérée sur Instagram qui vire au gris triste dans votre salon : un week-end et 300 € de peinture. Le tapis trop petit, la suspension trop basse, la table qui bloque le passage… La bonne question, c'est plutôt le coût des erreurs qu'une décoratrice vous évite. Sur un projet de pièce à 8 000 € d'achats, une seule erreur majeure évitée finance l'essentiel des honoraires.</p>
...
<p>The oversized sofa ordered on impulse: €2,000. The shade spotted on Instagram that turns sad grey in your living room: a weekend and €300 of paint. The too-small rug, the too-low pendant, the table that blocks the walkway… The better question is what the mistakes a decorator prevents would cost you. On a room with an €8,000 purchase budget, a single major mistake avoided funds most of the fees.</p>
