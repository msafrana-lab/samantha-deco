...
1. Champs `[À COMPLÉTER]` des pages légales — SIRET dès immatriculation
   (statut : micro-entreprise, TVA non applicable art. 293 B, déjà indiqué)
2. Bio réelle de Samantha sur /a-propos/ et /en/about/
   (portrait et 12 photos avant/après : déjà intégrés ✓)
